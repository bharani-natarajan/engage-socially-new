...
export default function PostCard({ post }) {
  ...
  return (
    <>
      <div className="group flex flex-col rounded-xl overflow-hidden bg-white border border-gray-200 hover:border-violet-300 hover:shadow-lg hover:shadow-violet-500/10 transition-all">
        {/* Thumbnail */}
        <Link href={`/posts/${post.id}`} className="relative aspect-square overflow-hidden bg-gray-100 block">
          {thumb ? (
